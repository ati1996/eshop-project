...
function jdate($type,$maket="now",$tran="")
{
	...
	while($i<strlen($type))
	{
		...
		switch ($subtype)
		{
			...
			case "l":
				$result1=date("l",$need);
				if($result1=="Saturday") $result1="شنبه";//"&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Sunday") $result1="یک شنبه";//"&#1610;&#1603;&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Monday") $result1="دو شنبه";//"&#1583;&#1608;&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Tuesday") $result1="سه شنبه";//"&#1587;&#1607;&#32;&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Wednesday") $result1="چهار شنبه";//"&#1670;&#1607;&#1575;&#1585;&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Thursday") $result1=" پنج شنبه";//"&#1662;&#1606;&#1580;&#1588;&#1606;&#1576;&#1607;";
				else if($result1=="Friday") $result1="جمعه";//"&#1580;&#1605;&#1593;&#1607;";
				$result.=$result1;
				break;
			case "m":
...
function mlj($date){ //for find jmaketime date
	...
	function shamsidate()
	{
		...
		echo(jdate("l")." ".Convertnumber2farsi($d[2])." ".monthname($d[1])." ".Convertnumber2farsi($d[0])); 	
